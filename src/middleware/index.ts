...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://api.open-meteo.com https://air-quality-api.open-meteo.com https://geocoding-api.open-meteo.com https://*.openfreemap.org https://*.maptiler.com https://map-tiles.open-meteo.com https://openmeteo.s3.amazonaws.com",
      "font-src 'self' data:",
